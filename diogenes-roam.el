...
(declare-function diogenes-citation-abbreviation "diogenes-abbreviations"
...
(defvar diogenes-org-capture-template)
...
(defun diogenes-roam--parts-from-browser ()
  ...
  (when (derived-mode-p 'diogenes-browser-mode)
    (when-let ((it (ignore-errors (diogenes-browser-reference))))
      ...
      (or (cdr (assoc (list (nth 0 p) (nth 1 p)) diogenes-roam-name-overrides))
          (diogenes-roam--slug
           (or (diogenes-roam--first-word
               ...
               (diogenes-roam--tidy
                (car (ignore-errors
                       (diogenes-citation-abbreviation (nth 0 p) (nth 1 p))))))
      ...
      (diogenes-roam--slug
       (diogenes-roam--tidy
        (or (ignore-errors
            ...
            (cdr (ignore-errors
                   (diogenes-citation-abbreviation
